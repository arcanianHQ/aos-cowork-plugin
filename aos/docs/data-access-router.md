...
`client` · `inbox` · `brand` · `content` · `content-system` · `campaigns` ·
`dictionaries` · `ontology` · `metrics` · `deliverables` — plus the root files
(`AOS_CONFIG.md`, `TASKS.md`, `LEADS.md`, `CAPTAINS_LOG.md`).
